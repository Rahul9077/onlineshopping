...
base.header()
query_1 = "select * from productdetail where p_id = %s"
...
<hr>
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <a href="Payment.py?p_id={}" class="btn btn-primary">BUY NOW</a>
            </div>
        </div>
    </div>
""".format(products[0][-1], products[0][2], products[0][4],
productsdetails[0][2],productsdetails[0][4],productsdetails[0][3],
productsdetails[0][-1],products[0][0]))

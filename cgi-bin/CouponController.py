...
totalcart=form.getvalue('q')
print(coupon,totalcart)
totalcart=int(totalcart)
tc,discount=model.coupons(coupon,totalcart)
...
<div class="card text-black bg-primary mb-3" style="width: 18rem;margin-bottom:20px; padding:10px;">
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">Coupon Applied</li>
    <form>
  
  <input type="hidden" value={} name="totalcart">
...
""".format(totalcart, totalcart,discount,tc))
